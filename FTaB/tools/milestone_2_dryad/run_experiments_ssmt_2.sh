...
for THREAD_COUNT in 1 2 4 5 10 20 25 50 
do
    for USER_COUNT in 250
    do
        ...
        ssh -o UserKnownHostsFile=/home/user25/network/known_hosts -i /home/user25/network/asl-key-nopwd $CLIENT "bash /home/user25/tools/milestone_2_dryad/tar_logs.sh trace_18_12_${THREAD_COUNT}_${USER_COUNT}.tgz"
        ssh -o UserKnownHostsFile=/home/user25/network/known_hosts -i /home/user25/network/asl-key-nopwd $SERVER "bash /home/user25/tools/milestone_2_dryad/tar_logs.sh trace_18_12_${THREAD_COUNT}_${USER_COUNT}.tgz"
    done
done
