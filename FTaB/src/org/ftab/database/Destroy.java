...
/**
 * DAO for dropping the system's table from the database. It is meant only for
 * tests and should be used carefully.
 */
public class Destroy {
     ...
     * 
     * @param client
     *            indicates if the client table should be dropped.
     * @param queue
     *            indicates if the queue table should be dropped.
     * @param msg
     *            indicates if the message table should be dropped.
     * @param conn
     *            database connection.
     * @throws SQLException
