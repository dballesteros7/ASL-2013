...
public class FetchClient {
	 ...
	 * @return 					object with the information about the client
	 * 							in the database if such exists,
	 * 							otherwise it is null.
	 * @throws 	SQLException	if a problem occurs while executing the query
	 * 							in the database.a
	 */
	public UserClient execute(String username, Connection conn)
			throws SQLException{
		Statement stmt = null;
		try{
			...
			if(!result.next()){
				...
				UserClient formattedResult = new UserClient(result.getInt(1), 
