...
public class Create {
    ...
    private final static String SQL01_CREATE_CLIENT = "CREATE TABLE client ("
            + "id SERIAL PRIMARY KEY, username VARCHAR(200) NOT NULL,"
            + "online BOOLEAN DEFAULT false, UNIQUE(username))";
     ...
     */
    private final static String SQL04_MSG_QUEUE_ASSOC_QUEUE_IDX =
            "CREATE INDEX"
     ...
     * 
     * @param client
     *            indicates if the client table should be created.
     * @param queue
     *            indicates if the queue table should be created.
     * @param msg
     *            indicates if the message table should be created, creating the
     *            message table implies creating the client and queue table.
     * @param conn
     *            database connection.
     * @throws SQLException
