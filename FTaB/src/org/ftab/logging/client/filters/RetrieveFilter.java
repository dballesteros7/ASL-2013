...
/**
 * Filters a log messages to only allow Retrieve non-error log messages
 * @author Diego Ballesteros (diegob)
 *
 */
public class RetrieveFilter implements Filter {
    @Override
    public boolean isLoggable(LogRecord record) {
        if (record instanceof ClientLogRecord) {
            ...
            if (cRecord.getEventCategory() == SystemEvent.RETRIEVE_MESSAGE) {
