...
/**
 * Class that represents a client, i.e. a component in the
 * first tier of the messaging system. This contains the information
 * about the client that is stored in the database.
 */
public class UserClient {
	...
	public UserClient(final int nClientId, final String nUsername,
