...
public class ServerManagerTest {
	...
	@Test
	public void testBroadcast() throws SQLException, QueueInexistentException,
			UnspecifiedErrorException, ClientInexistentException, IOException,
			InvalidHeaderException, FullServerException,
			AlreadyOnlineException, QueueAEException {
		Connection conn;
	...
	@Test
	public void testPingPong() throws SQLException, UnspecifiedErrorException,
			FullServerException, AlreadyOnlineException, IOException,
			InvalidHeaderException, QueueAEException, QueueInexistentException, ClientInexistentException {
		Connection conn;
		assertTrue(alice.Connect("localhost", 34582));
